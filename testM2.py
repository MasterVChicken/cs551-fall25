...
def correctness_tester1():
    ...
    try:
        ...
        # We create the search index on column 2
        # We are then looking for where we have data "1" in column 2 (of the
        # data). So we want to get *every* record which has a 1.
        # In this case, record[0], record[1], 5, and 7
    ...
    try:
        ...
        # Dropping the index 2 means that we should have a different
        # organization of records, so the result should be different.
        # But beware that this doesn't mean students did it correctly.
    ...
    try:
        ...
        # We can modify this primary key because it will still be unique
        # Which means key 7 disappears! 
    ...
    try:
        ...
        # If result[0] == records2[0]
        # Results[0] because results is returning type [[]]
